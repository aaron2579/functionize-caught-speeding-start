...
function btnClicked() {
  ...
  document.getElementById("d1-ticket").innerHTML = ticketPrice(d1Speed, d1Limit)
  document.getElementById("d2-ticket").innerHTML = ticketPrice(d2Speed, d2Limit)
  document.getElementById("d3-ticket").innerHTML = ticketPrice(d3Speed, d3Limit)
}
function ticketPrice(speed, limit) {
  let ticket;
  if (speed > limit + 40) {
